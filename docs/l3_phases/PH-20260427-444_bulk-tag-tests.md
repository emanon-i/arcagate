...
## status: deferred (batch-98 持ち越し)

batch-97 着手時点で batch-96 PR #157 が main に未 merge、bulk_add_tag 関数本体が main にない。
PR #157 merge → main rebase で batch-97 ブランチに取り込まれた後、batch-98 で本 plan 実装。
