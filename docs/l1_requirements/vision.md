...
| 性能予算         | 起動 / Palette / アイテム起動 / メモリ / CPU / exe サイズ → §UX 標準「パフォーマンス目標値」が正本 |
| コスト           | ゼロコスト運用                                                                                     |
...
| 項目               | 要求                                                                        |
| ------------------ | --------------------------------------------------------------------------- |
| 性能予算           | 起動 / メモリ / CPU / exe サイズは §UX 標準「パフォーマンス目標値」が正本   |
...
> **perf 予算の正本 (SSOT)**。l0 成功条件 / §2.1 制約 / §4 非機能 / foundation §10 はこの表を参照し、数値を複製しない。
