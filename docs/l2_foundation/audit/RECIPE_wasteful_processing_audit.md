...
| `docs/l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_2026-05-19.md` | **既存 audit 例**。発見項目 W-1〜W-8 の書式・粒度の参照雛形。再発見した場合は「既対処」注記を付ける                    |
...
5. **表化**: 発見項目を以下の軸で整理する。
   ...
   - 関連 spec / 該当コード `path:line` / spec で禁止されてること / 現実装の挙動 / なぜ無駄か /
     推奨対処 / 工数感 (〜分 / 半日 / 1 日)
6. **出力**: `docs/l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_<YYYY-MM-DD>.md` に
...
`docs/l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_<YYYY-MM-DD>.md` を以下の構成で書く。
...
- §5 のフォーマットで docs/l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_<本日日付>.md に出力
...
- 既存 audit 例: [`../../l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_2026-05-19.md`](../../l3_phases/audit/WASTEFUL_PROCESSING_AUDIT_2026-05-19.md)
