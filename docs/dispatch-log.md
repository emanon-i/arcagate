...
`pnpm tauri dev` を起動して確認してください（Alt+Space でパレット呼び出し）。
...
| #  | 対象                     | 操作                                            | 期待挙動                                              | 由来        |
| -- | ------------------------ | ----------------------------------------------- | ----------------------------------------------------- | ----------- |
| 1  | グローバルホットキー     | **Alt+Space**                                   | パレットウィンドウがフワッと降りてくる                | PH-098      |
...
| 19 | パレット開閉アニメ        | Alt+Space 開閉を繰り返す             | 開: fly (200ms)、閉: fade (120ms)                   | PH-153       |
