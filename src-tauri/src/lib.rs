...
use commands::widget_item_settings_commands::{
    cmd_delete_all_widget_item_settings, cmd_delete_widget_item_settings,
    cmd_get_widget_item_settings, cmd_list_widget_item_settings, cmd_patch_widget_item_settings,
    cmd_prune_orphan_widget_item_settings, cmd_touch_widget_item_settings,
};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd_patch_widget_item_settings,
            cmd_touch_widget_item_settings,
            cmd_delete_widget_item_settings,
            cmd_delete_all_widget_item_settings,
            cmd_prune_orphan_widget_item_settings,
        ])
